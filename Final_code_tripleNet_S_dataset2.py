# -*- coding: utf-8 -*-
"""
Created on Wed May 15 22:26:36 2024
...
def TripleNet_S(input_shape=(28, 28, 1), num_classes=10):
...
# Train the model
history = model.fit(train_images, train_labels, batch_size=128, epochs=50, validation_data=(test_images, test_labels))
...
for i in range(5):
    ...
    plt.yticks([])
    plt.grid(False)
    temp = cv2.rectangle(test_images[i].copy(), (bbox[0], bbox[1]), (bbox[2], bbox[3]), (0, 255, 0), 1)
